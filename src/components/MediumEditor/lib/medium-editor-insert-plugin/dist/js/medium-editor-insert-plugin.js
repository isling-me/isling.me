...
export default function (jQuery, Handlebars, MediumEditor) {

window["MediumInsert"] = window["MediumInsert"] || {};
window["MediumInsert"]["Templates"] = window["MediumInsert"]["Templates"] || {};

window["MediumInsert"]["Templates"]["src/js/templates/core-buttons.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
...
window["MediumInsert"]["Templates"]["src/js/templates/core-caption.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;
...
window["MediumInsert"]["Templates"]["src/js/templates/core-empty-line.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<p><br></p>\n";
},"useData":true});

window["MediumInsert"]["Templates"]["src/js/templates/embeds-toolbar.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;
...
window["MediumInsert"]["Templates"]["src/js/templates/embeds-wrapper.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper;
...
window["MediumInsert"]["Templates"]["src/js/templates/images-fileupload.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<input type=\"file\" multiple>";
},"useData":true});

window["MediumInsert"]["Templates"]["src/js/templates/images-image.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
...
window["MediumInsert"]["Templates"]["src/js/templates/images-progressbar.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<progress min=\"0\" max=\"100\" value=\"0\">0</progress>";
},"useData":true});

window["MediumInsert"]["Templates"]["src/js/templates/images-toolbar.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;
...
;(function ($, window, document) {
    ...
    Core.prototype.hideButtons = function ($el) {
        $el = $el || this.$el;
        if (typeof this.options.handleHideAddons === 'function') {
            this.options.handleHideAddons();
        };
    ...
    Core.prototype.toggleAddons = function () {
        ...
        if (this.$el.find('.medium-insert-buttons-show').hasClass('medium-insert-buttons-rotate')) {
            ...
            if (typeof this.options.handleShowAddons === 'function') {
                this.options.handleShowAddons();
            };
        }        
...
; (function ($, window, document, Util) {
    ...
    Images.prototype.uploadAdd = function (e, data) {
        ...
        if (this.options.uploadAdd) {
            this.options.uploadAdd(data.context, data);
        }
    ...
    Images.prototype.uploadProgressall = function (e, data) {
        ...
        if (this.options.uploadProgressAll) {
            this.options.uploadProgressAll(data.context, data);
        }
    };
    ...
    Images.prototype.uploadProgress = function (e, data) {
        ...
        if (this.options.preview) {
            ...
            if (this.options.uploadProgress) {
                this.options.uploadProgress(data.context, data);
            }
        }
    };
